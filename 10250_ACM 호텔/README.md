...
<img width="{420}" src="{https://www.acmicpc.net/upload/images2/elevator.png}"/>
...
# 문제 접근
  ...
  - 우선적으로 XXYY호에서 고객들이 101호 다음으로 201호를 제일 선호 함.

  - 입력받은 n이 h를 넘었을 때 차례로 h01호 다음에 102호를 산출하는 식을 if문을 통해 구현. 